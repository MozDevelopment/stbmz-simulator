...
const formSchema = z.object({
    ...
    productType: z.enum(["creditoPessoal", "creditoHabitacao", "leasingMobiliario", "leasingImobiliario"]),
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                ...
                                <SelectContent>
                                    <SelectItem value="creditoPessoal">{t('personalCredit')}</SelectItem>
                                    <SelectItem value="creditoHabitacao">{t('mortgageCredit')}</SelectItem>
                                    <SelectItem value="leasingMobiliario">{t('mobileLease')}</SelectItem>
                                    <SelectItem value="leasingImobiliario">{t('realEstateLease')}</SelectItem>
                                </SelectContent>
                            </Select>
                            <FormMessage />
                        </FormItem>
